...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="/foodvoting/css/style.css" type="text/css" media="screen, projection, tv"/>
    <link rel="stylesheet" href="/foodvoting/css/style-print.css" type="text/css" media="print"/>
...
<div id="wrapper">
    ...
    <ul id="menu" class="cleaning-box">
        <c:if test="${isLoggedIn == true}">
            <li><a href="/foodvoting/welcome">HOME</a></li>
            <li><a href="/foodvoting/foodlist">FOOD LIST</a></li>
            <li><a href="/foodvoting/vote">VOTE</a></li>
            <c:if test="${USER.admin == true}">
                <li><a href="/foodvoting/viewvote">VIEW VOTE</a></li>
            </c:if>
            <li><a href="/foodvoting/logout">LOG OUT</a></li>
        </c:if>
    </ul>
